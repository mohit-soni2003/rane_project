// This component show the details of particular DFS and help to take action when it is assigned to the client by admin or staff 
// for uploading new file or reviewing it 
  ...
  const loadData = async () => {
    try {
      ...
      if (lastToMe?.forwardedBy) {
        setUsers([lastToMe.forwardedBy]); // just that one user
      }
