...
// ── All enum values from the schema (static) ──────────────────────────────────
const DOC_TYPES = [
...
// ── Delete confirm modal (portal — renders into document.body) ────────────────
        ...
        <div style={{ display: 'flex', gap: 10, padding: '0 24px 24px' }}>
          ...
          <button
            ...
            style={{
              ...
              justifyContent: 'center', gap: 7, padding: '10px', borderRadius: 10,
  ...
  return (
    <>
                  ...
                  <tbody>
                    {filteredDocuments.map((doc, index) => (
                      ...
                      >
                        ...
                        <td style={{ padding: '11px 12px', fontWeight: 600, color: 'var(--text-strong)' }}>
                          {doc.docType || '—'}
                        </td>
                        ...
                        <td style={{ padding: '11px 12px' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            {doc.userId?.profile ? (
                              <img src={doc.userId.profile} alt={doc.userId.name}
                        ...
                        <td style={{ padding: '11px 12px', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>
                          {fmtDate(doc.dateOfIssue)}
                        </td>
                        <td style={{ padding: '11px 12px', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>
                          ...
                          {doc.documentLink ? (
                            <a href={doc.documentLink} target="_blank" rel="noreferrer" title="View Document"
                              style={{
                                ...
                                color: 'var(--secondary-foreground)', textDecoration: 'none',
                              }}>
                        ...
                        <td style={{ padding: '11px 12px', color: 'var(--text-muted)', fontSize: 12, whiteSpace: 'nowrap' }}>
                          {fmtDateTime(doc.statusUpdatedAt)}
                        </td>
                        <td style={{ padding: '11px 12px' }}>
                          <button
                      ...
                      {[
                        ...
                        { label: 'Status Change', value: fmtDateTime(doc.statusUpdatedAt) },
                        {
                          ...
                          value: doc.documentLink ? (
                            <a href={doc.documentLink} target="_blank" rel="noreferrer"
      ...
      <DeleteConfirmModal
        ...
        onClose={() => { if (!deleting) { setShowDeleteModal(false); setSelectedDocumentId(null); } }}
