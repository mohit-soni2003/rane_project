...
import {
    ...
    FaExternalLinkAlt, FaSignature, FaClock, FaInfoCircle, FaCheckCircle,
    FaTimesCircle, FaUndo, FaArrowLeft,
} from 'react-icons/fa';
...
const sectionStyle = { borderTop: '1px solid var(--divider)', padding: '14px 18px' };
...
export default function SingleProjectDetail() {
    ...
    const fetchProject = async () => {
        ...
        try {
            ...
            // NOTE: adjust this endpoint to whatever your API exposes for a
            // single project (e.g. GET /project/:id).
            const res = await fetch(`${backend_url}/project/details/${id}`, {
                method: 'GET',
                headers: {
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            color: 'var(--secondary-foreground)', fontSize: 13, fontWeight: 600, cursor: 'pointer',
                        }}
                    >
                        <FaArrowLeft size={12} /> Back to pending list
                    </button>
                    <button
                ...
                {!loading && !error && p && (() => {
                    ...
                    return (
                        <div style={cardStyle}>
                            ...
                            {/* Record metadata — Mongo _id intentionally omitted */}
