  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh' }}>
      ...
      <div className="d-none d-md-block position-fixed top-0 start-0" style={{ zIndex: 1050 }}>
        <AdminSidebar key="desktop-sidebar" isOpen={true} onCollapse={handleSidebarCollapse} />
      </div>

      {/* ── Mobile drawer (always mounted → slides in/out) ── */}
      <div
        className="d-md-none position-fixed top-0 start-0"
        style={{
          zIndex: 1050,
      ...
      >
        <AdminSidebar key="mobile-sidebar" isOpen={true} toggleSidebar={toggleSidebar} />
      </div>
